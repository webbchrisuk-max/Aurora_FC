(() => {
  'use strict';
  const BUILD='20260904-clean-bill-audit-7-any-pot-payment-loader';
  const MONTHLY_BILLS_SRC='finance-bills-monthly.js?v=20260904-finance-bills-monthly-3-display-only';
  const BILL_PAYMENT_SRC='finance-bill-payment.js?v=20260904-finance-bill-payment-5-any-pot-source';
