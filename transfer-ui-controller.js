 ...
 * Single presentation owner for Finance mission intake and locked-route display.
 * Business engines remain separate: scouting, allocation, broker rules, route save/guards and Chairman logic.
 */
(() => {
  'use strict';
